...
tennis4: tennis4.c winsuport2.c winsuport2.h memoria.o
	gcc tennis4.c winsuport2.o memoria.o -o tennis4 -lcurses -lpthread
	gcc pal_ord4.c winsuport2.o memoria.o -o pal_ord4 -lcurses
